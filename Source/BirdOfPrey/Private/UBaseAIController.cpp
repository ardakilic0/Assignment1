...
void AUBaseAIController::SelectTarget()
{
}
...
bool AUBaseAIController::ShouldStartFire()
{
	return false;
}

bool AUBaseAIController::ShouldStopFire()
{
	return false;
}
...
bool AUBaseAIController::ShouldUpdateAim()
{
	return false;
}
